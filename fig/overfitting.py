...
def run_network(filename, num_epochs, training_set_size=1000, lmbda=0.0):
    ...
    test_cost, test_accuracy, training_cost, training_accuracy \
        = net.SGD(training_data[:training_set_size], num_epochs, set_mini_batch_size, set_eta,
...
if __name__ == "__main__":
    ...
    set_mini_batch_size = int(input(
        "Enter the mini_batch_size, size(suggest: 10): "))
    set_eta = float(input(
        "Enter the eta parameter, eta (suggest: 0.5): "))
    lmbda = float(input(
    ...
    main(filename, num_epochs, training_cost_xmin, 
         ...
         training_set_size, set_eta,set_mini_batch_size,lmbda)
